...
extern "C"
JNIEXPORT void JNICALL
Java_com_sgowen_ggj21_Engine_onWindowSizeChanged(JNIEnv *env, jobject thiz, jint screen_width, jint screen_height, jint cursor_width, jint cursor_height)
{
...
extern "C"
JNIEXPORT void JNICALL
Java_com_sgowen_ggj21_Engine_onResume(JNIEnv *env, jobject thiz)
{
    _engine->onResume();
}
...
extern "C"
JNIEXPORT void JNICALL
Java_com_sgowen_ggj21_Engine_onPause(JNIEnv *env, jobject thiz)
{
    _engine->onPause();
}
...
Java_com_sgowen_ggj21_Engine_update(JNIEnv *env, jobject thiz, jdouble delta_time)
{
...
extern "C"
JNIEXPORT void JNICALL
Java_com_sgowen_ggj21_Engine_render(JNIEnv *env, jobject thiz)
{
    _engine->render();
}
...
extern "C"
JNIEXPORT void JNICALL
Java_com_sgowen_ggj21_Engine_onCursorDown(JNIEnv *env, jobject thiz, jfloat x, jfloat y)
{
...
extern "C"
JNIEXPORT void JNICALL
Java_com_sgowen_ggj21_Engine_onCursorDragged(JNIEnv *env, jobject thiz, jfloat x, jfloat y)
{
...
extern "C"
JNIEXPORT void JNICALL
Java_com_sgowen_ggj21_Engine_onCursorUp(JNIEnv *env, jobject thiz, jfloat x, jfloat y)
{
